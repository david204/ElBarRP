...
RegisterNetEvent('nc:client:SellLegalFish')
AddEventHandler('nc:client:SellLegalFish', function()
    exports['qb-menu']:openMenu({
		{
...
RegisterNetEvent('nc:client:buyFishingGear')
AddEventHandler('nc:client:buyFishingGear', function() 
    exports['qb-menu']:openMenu({
		{
...
RegisterNetEvent('nc:client:SellillegalFish')
AddEventHandler('nc:client:SellillegalFish', function() 
	QBCore.Functions.TriggerCallback('QBCore:HasItem', function(HasItem)
		if HasItem then
			...
			QBCore.Functions.Notify('You cannot sell to us, you need - Pearls Seafood Card. Sorry for the inconvenience', 'error', 3500)
		end
	end, "pearlscard")
end)
