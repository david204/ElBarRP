...
Config.Skillbar = "nc-skillbar"                             	-- Must choose one of the avalible skillbars ["reload-skillbar","np-skillbar","qb-skillbar"]
...
Config.BoatSpawnLocation = {
	...
	ActDam 		= vector4(1691.67, 33.1, 160.53, 281.68),
...
Config.PlayerReturnLocation = {
	...
	ActDam 		= vector4(1693.41, 41.21, 161.77, 93.37),
	AlamoSea 	= vector4(1301.1, 4233.696, 33.909, 337.548),        
}

-- Gear
Config.fishingRodPrice = 1000                                     -- Price of a fishing rod
Config.fishingBaitPrice = 22                                    -- Price of fishing bait
Config.BoatAnchorPrice = 500                                    -- Price of a Boat Anchor
Config.FishingBoxPrice = 1750                                   -- Price of a Fishing Ice Box

-- Regular Fish
Config.mackerelPrice     = 20                                    -- Price of Mackerel
Config.codfishPrice      = 40                                   -- Price of Cod
Config.bassPrice         = 60                                   -- Price of Normal Fish
Config.flounderPrice     = 80                                   -- Price of Flounder
Config.stingrayPrice     = 100                                   -- Price of Stingrays

-- Exotic Fish
Config.dolphinPrice      = 300                                  -- Price of Dolphins
Config.sharktigerPrice   = 400                                  -- Price of Tigersharks
Config.sharkhammerPrice  = 500                                  -- Price of Hammerhead Sharks
Config.killerwhalePrice  = 600                                  -- Price of Killer whales
...
Config.PedList = {                                              -- Peds that will be spawned in (if you change a ped model here you need to also change the ped model in client/addons.lua qb-target exports)
	{
		model = "a_f_y_fitness_01",                            -- Boat/Gear Menu
	...
	{
		model = "a_f_y_yoga_01",                            -- Boat/Gear Menu
