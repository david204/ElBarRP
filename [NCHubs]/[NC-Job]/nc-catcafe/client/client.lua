...
CreateThread(function()
	...
	exports['qb-target']:AddBoxZone("CatPrepared", vector3(-587.4, -1059.6, 23.45), 2.0, 2.5, { name="CatPrepared", heading = 270.0, debugPoly=Config.Debug, minZ=21.45, maxZ=23.45 }, 
		{ options = { {  event = "nc-catcafe:Stash", icon = "fas fa-box-open", label = "Prepared Food", stash = "Shelf" }, },  distance = 2.0 })
	--FRIDGE
	exports['qb-target']:AddBoxZone("CatFridge", vector3(-588.06, -1067.1, 22.34), 3.5, 0.5, { name="CatFridge", heading = 0, debugPoly=Config.Debug, minZ=19.84, maxZ=23.84 }, 
		{ options = { {  event = "nc-catcafe:Stash", icon = "fas fa-temperature-low", label = "Open Fridge", stash = "Fridge", job = "catcafe" }, }, distance = 1.0 })		
	exports['qb-target']:AddBoxZone("CatFridge2", vector3(-590.67, -1068.1, 22.34), 2.0, 0.6, { name="CatFridge2", heading = 0, debugPoly=Config.Debug, minZ=19.84, maxZ=23.84 }, 
		{ options = { {  event = "nc-catcafe:Stash", icon = "fas fa-temperature-low", label = "Open Fridge", stash = "Fridge2", job = "catcafe"  }, }, distance = 1.0 })
	--WARESTORAGE
	exports['qb-target']:AddBoxZone("CatStorage", vector3(-598.0, -1068.47, 22.34), 4.0, 1.5, { name="CatStorage", heading = 90, debugPoly=Config.Debug, minZ=20.94, maxZ=24.94 }, 
		{ options = { {  event = "nc-catcafe:Shop", icon = "fas fa-box-open", label = "Open Store", job = "catcafe" }, }, distance = 2.0 })
	...
	exports['qb-target']:AddBoxZone("CatWash1", vector3(-587.89, -1062.58, 22.36), 0.7, 0.7, { name="CatWash1", heading = 0, debugPoly=Config.Debug, minZ=19.11, maxZ=23.11 }, 
		{ options = { { event = "nc-catcafe:washHands", icon = "fas fa-hand-holding-water", label = "Wash Your Hands" }, }, distance = 1.5	})		
	exports['qb-target']:AddBoxZone("CatWash2", vector3(-570.23, -1051.41, 22.34), 0.5, 0.5, { name="CatWash2", heading = 0, debugPoly=Config.Debug, minZ=21.74, maxZ=22.94, }, 
		{ options = { { event = "nc-catcafe:washHands", icon = "fas fa-hand-holding-water", label = "Wash Your Hands" }, }, distance = 1.2	})		
	...
	exports['qb-target']:AddBoxZone("CatOven", vector3(-590.66, -1059.13, 22.34), 2.5, 0.6, { name="CatOven", heading = 0, debugPoly=Config.Debug, minZ = 19.84, maxZ = 23.84, }, 
		{ options = { { event = "nc-catcafe:Menu:Oven", icon = "fas fa-temperature-high", label = "Use Oven", job = "catcafe" }, }, distance = 2.0 })
	--Hob
	exports['qb-target']:AddBoxZone("CatHob", vector3(-591.02, -1056.56, 22.36), 1.5, 0.6, { name="CatHob", heading = 0, debugPoly=Config.Debug, minZ = 19.84, maxZ = 23.84, }, 
		{ options = { { event = "nc-catcafe:Menu:Hob", icon = "fas fa-temperature-high", label = "Use Hob", job = "catcafe" }, }, distance = 2.0 })
	--Trays
	exports['qb-target']:AddBoxZone("CatCounter", vector3(-584.01, -1059.27, 22.34), 0.6, 0.6, { name="CatCounter", heading = 0, debugPoly=Config.Debug, minZ=19.04, maxZ=23.04 }, 
		{ options = { { event = "nc-catcafe:Stash", icon = "fas fa-hamburger", label = "Open Counter", stash = "Counter" }, }, distance = 2.0	})	
	exports['qb-target']:AddBoxZone("CatCounter2", vector3(-584.04, -1062.05, 22.34), 0.6, 0.6, { name="CatCounter2", heading = 0, debugPoly=Config.Debug, minZ=19.04, maxZ=23.04 }, 
		{ options = { { event = "nc-catcafe:Stash", icon = "fas fa-hamburger", label = "Open Counter", stash = "Counter2" }, }, distance = 2.0	})
	--Payments
	...
	exports['qb-target']:AddBoxZone("CatCoffee", vector3(-586.8, -1061.89, 22.34), 0.7, 0.5, { name="CatCoffee", heading = 0, debugPoly=Config.Debug, minZ=21.99, maxZ=23.19 }, 
		{ options = { { event = "nc-catcafe:Menu:Coffee", icon = "fas fa-mug-hot", label = "Pour Coffee", job = "catcafe" }, }, distance = 2.0 })
	--Chopping Board
	exports['qb-target']:AddBoxZone("CatBoard", vector3(-590.94, -1063.16, 22.36), 1.5, 0.6, { name="CatBoard", heading = 0, debugPoly=Config.Debug, minZ=18.96, maxZ=22.96, }, 
		{ options = { { event = "nc-catcafe:Menu:ChoppingBoard", icon = "fas fa-utensils", label = "Prepare Food", job = "catcafe" }, }, distance = 2.0 })	
	--Tables
	exports['qb-target']:AddBoxZone("CatTable", vector3(-573.43, -1059.76, 22.49), 1.9, 1.0, { name="CatTable", heading = 91.0, debugPoly=Config.Debug, minZ=21.49, maxZ=22.89 }, 
		{ options = { {  event = "nc-catcafe:Stash", icon = "fas fa-box-open", label = "Search Table", stash = "Table_1" }, }, distance = 2.0 })
	exports['qb-target']:AddBoxZone("CatTable2", vector3(-573.44, -1063.45, 22.34), 1.9, 1.0, { name="CatTable2", heading = 91.0, debugPoly=Config.Debug, minZ=21.49, maxZ=22.89 }, 
		{ options = { {  event = "nc-catcafe:Stash", icon = "fas fa-box-open", label = "Search Table", stash = "Table_2" }, }, distance = 2.0 })
	exports['qb-target']:AddBoxZone("CatTable3", vector3(-573.41, -1067.09, 22.49), 1.9, 1.0, { name="CatTable3", heading = 91.0, debugPoly=Config.Debug, minZ=21.49, maxZ=22.89 }, 
		{ options = { {  event = "nc-catcafe:Stash", icon = "fas fa-box-open", label = "Search Table", stash = "Table_3" }, }, distance = 2.0 })
	exports['qb-target']:AddBoxZone("CatTable4", vector3(-578.68, -1051.09, 22.35), 1.2, 0.9, { name="CatTable4", heading = 91.0, debugPoly=Config.Debug, minZ=21.49, maxZ=22.89 }, 
		{ options = { {  event = "nc-catcafe:Stash", icon = "fas fa-box-open", label = "Search Table", stash = "Table_4" }, }, distance = 2.0 })	
	--Clockin
...
RegisterNetEvent('nc-catcafe:washHands', function()
...
RegisterNetEvent('nc-catcafe:MakeItem', function(data)
	if data.craftable then
		for k, v in pairs(data.craftable[data.tablenumber]) do
			QBCore.Functions.TriggerCallback('nc-catcafe:get', function(amount)
				if not amount then TriggerEvent('QBCore:Notify', "You don't have the correct ingredients", 'error') else TriggerEvent("nc-catcafe:FoodProgress", data) end		
			end, data.item, data.tablenumber, data.craftable)
		end
	end
end)

RegisterNetEvent('nc-catcafe:Stash', function(data) TriggerServerEvent("inventory:server:OpenInventory", "stash", "CatCafe_"..data.stash) TriggerEvent("inventory:client:SetCurrentStash", "CatCafe_"..data.stash) end)

RegisterNetEvent('nc-catcafe:Shop', function() if not jobCheck() then return else TriggerServerEvent("inventory:server:OpenInventory", "shop", "catcafe", Config.Items) end end)

RegisterNetEvent('nc-catcafe:FoodProgress', function(data)
	...
	{}, {}, function()  
		TriggerServerEvent('nc-catcafe:GetFood', data)
...
RegisterNetEvent('nc-catcafe:Menu:ChoppingBoard', function()
			...
			for k, v in pairs(Crafting.ChoppingBoard[i]) do
				if k ~= "img" then
					...
					ChopMenu[#ChopMenu + 1] = { header = "<img src=nui://"..Config.link..QBCore.Shared.Items[k].image.." width=35px> "..setheader, txt = settext, 
												params = { event = "nc-catcafe:MakeItem", args = { item = k, tablenumber = i, craftable = Crafting.ChoppingBoard,
...
RegisterNetEvent('nc-catcafe:Menu:Oven', function()
	if not jobCheck() then return end
	local OvenMenu = {}
			...
			for k, v in pairs(Crafting.Oven[i]) do
				if k ~= "img" then
					...
					OvenMenu[#OvenMenu + 1] = { header = "<img src=nui://"..Config.link..QBCore.Shared.Items[k].image.." width=35px> "..setheader, txt = settext, 
												params = { event = "nc-catcafe:MakeItem", args = { item = k, tablenumber = i, craftable = Crafting.Oven,
...
RegisterNetEvent('nc-catcafe:Menu:Coffee', function()
	if not jobCheck() then return end
	local CoffeeMenu = {}
			...
			for k, v in pairs(Crafting.Coffee[i]) do
				if k ~= "img" then
					...
					CoffeeMenu[#CoffeeMenu + 1] = { header = "<img src=nui://"..Config.link..QBCore.Shared.Items[k].image.." width=35px> "..setheader, txt = settext, 
													params = { event = "nc-catcafe:MakeItem", args = { item = k, tablenumber = i, craftable = Crafting.Coffee,
...
RegisterNetEvent('nc-catcafe:Menu:Hob', function()
	if not jobCheck() then return end
	local HobMenu = {}
			...
			for k, v in pairs(Crafting.Hob[i]) do
				if k ~= "img" then
					...
					HobMenu[#HobMenu + 1] = { header = "<img src=nui://"..Config.link..QBCore.Shared.Items[k].image.." width=35px> "..setheader, txt = settext, 
											  params = { event = "nc-catcafe:MakeItem", args = { item = k, tablenumber = i, craftable = Crafting.Hob,
...
RegisterNetEvent('nc-catcafe:client:DrinkAlcohol', function(itemName)
...
RegisterNetEvent('nc-catcafe:client:Drink', function(itemName)
...
RegisterNetEvent('nc-catcafe:client:Eat', function(itemName)
