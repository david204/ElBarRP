...
local function saveVehicle()
    ...
    TriggerServerEvent('nc-bennys:server:updateVehicle', myCar)
end
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("nc-bennys:server:attemptPurchase", type, upgradeLevel)
...
function EnterLocation(override)
    ...
    if Config.UseRadial then
        exports['nc-radialmenu']:RemoveOption(radialMenuItemId)
...
function GetLocations()
    QBCore.Functions.TriggerCallback("nc-bennys:server:GetLocations", function(locations)
...
function SetupInteraction()
    ...
    if Config.UseRadial then
        if not radialMenuItemId then
            radialMenuItemId = exports['nc-radialmenu']:AddOption({
                id = 'customs',
                title = 'Enter Customs',
                icon = 'wrench',
                type = 'client',
                event = 'nc-bennys:client:EnterCustoms',
                shouldClose = true
            })
        end
    else
...
RegisterNetEvent('nc-bennys:client:UpdateLocation', function(location, type, key, value)
    Config.Locations[location][type][key] = value
end)

RegisterNetEvent("nc-bennys:client:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    QBCore.Functions.Notify("Purchase Successful")
end)

RegisterNetEvent("nc-bennys:client:purchaseFailed", function()
    isPurchaseSuccessful = false
    attemptingPurchase = false
    QBCore.Functions.Notify("Not enough money", "error")
end)

RegisterNetEvent('nc-bennys:client:EnterCustoms', function(override)
