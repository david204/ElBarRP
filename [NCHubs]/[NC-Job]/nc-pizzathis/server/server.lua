...
CreateThread(function()
    ...
    for k,v in pairs(wines) do QBCore.Functions.CreateUseableItem(v, function(source, item) TriggerClientEvent('nc-pizzathis:client:DrinkAlcohol', source, item.name) end) end
	
	local beers = { "ambeer", "dusche", "logger", "pisswasser", "pisswasser2", "pisswasser3" }
    for k,v in pairs(beers) do QBCore.Functions.CreateUseableItem(v, function(source, item) TriggerClientEvent('nc-pizzathis:client:DrinkAlcohol', source, item.name) end) end
	
	local drink = { "sprunk", "sprunklight", "ecola", "ecolalight" }
    for k,v in pairs(drink) do QBCore.Functions.CreateUseableItem(v, function(source, item) TriggerClientEvent('nc-pizzathis:client:Drink', source, item.name) end) end
    ...
    for k,v in pairs(food) do QBCore.Functions.CreateUseableItem(v, function(source, item) TriggerClientEvent('nc-pizzathis:client:Eat', source, item.name) end) end
	
	local boxes = { "capricciosabox", "diavolabox", "marinarabox", "margheritabox", "prosciuttiobox", "vegetarianabox" }
    for k,v in pairs(boxes) do QBCore.Functions.CreateUseableItem(v, function(source, item) TriggerEvent('nc-pizzathis:OpenBox', source, item.name) end) end
end)

RegisterServerEvent('nc-pizzathis:GetFood')
AddEventHandler('nc-pizzathis:GetFood', function(ItemMake)
...
RegisterServerEvent('nc-pizzathis:OpenBox')
AddEventHandler('nc-pizzathis:OpenBox', function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
...
--Food
QBCore.Functions.CreateCallback('nc-pizzathis:get:bolognese', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('meat') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('sauce') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:calamari', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('squid') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('sauce') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pasta') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:meatball', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('meat') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pasta') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:alla', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('ham') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pasta') ~= nil  and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('vodka') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:pescatore', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('squid') ~= nil then cb(true) else cb(false) end end)

QBCore.Functions.CreateCallback('nc-pizzathis:get:margheritabox', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pizzabase') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('mozz') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:marinarabox', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pizzabase') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('basil') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:prosciuttiobox', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pizzabase') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('mozz') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('ham') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pizzmushrooms') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:diavolabox', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pizzabase') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('mozz') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('salami') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('basil') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:capricciosabox', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pizzabase') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('ham') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pizzmushrooms') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('olives') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:vegetarianabox', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pizzabase') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('mozz') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('lettuce') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('basil') ~= nil then cb(true) else cb(false) end end)

QBCore.Functions.CreateCallback('nc-pizzathis:get:ham', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('meat') ~= nil then cb(true) else cb(false) end end)
QBCore.Functions.CreateCallback('nc-pizzathis:get:salami', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('meat') ~= nil then cb(true) else cb(false) end end)

QBCore.Functions.CreateCallback('nc-pizzathis:get:pizzabase', function(source, cb) if QBCore.Functions.GetPlayer(source).Functions.GetItemByName('pizzadough') ~= nil and QBCore.Functions.GetPlayer(source).Functions.GetItemByName('sauce') ~= nil then cb(true) else cb(false) end end)