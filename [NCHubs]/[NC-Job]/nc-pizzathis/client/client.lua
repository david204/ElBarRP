...
CreateThread(function()
	...
	exports['qb-target']:AddBoxZone("PizzTray", vector3(811.94, -755.57, 26.78), 0.6, 1.6, { name="PizzTray", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.58, }, 
		{ options = { {  event = "nc-pizzathis:Stash", icon = "fas fa-box-open", label = "Toppings Tray", stash = "Toppings", job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzBase", vector3(811.42, -754.55, 26.78), 0.4, 0.4, { name="PizzBase", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.18, }, 
		{ options = { {  event = "nc-pizzathis:Menu:PizzaBase:Check", icon = "fas fa-pizza-slice", label = "Prepare Pizza", job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzDough", vector3(806.98, -757.05, 26.78), 1.2, 3.2, { name="PizzDough", heading = 0.0, debugPoly=Config.Debug, minZ = 25.78, maxZ = 27.58, }, 
		{ options = { {  event = "nc-pizzathis:JustGive", icon = "fas fa-cookie", label = "Prepare Dough", job = "pizzathis", id = "pizzadough" }, }, distance = 1.0 })	
	...
	exports['qb-target']:AddBoxZone("PizzOven", vector3(808.28, -761.19, 26.78), 2.8, 0.7, { name="PizzOven", heading = 0.0, debugPoly=Config.Debug, minZ = 26.18, maxZ = 27.38, }, 
		{ options = { {  event = "nc-pizzathis:Menu:Oven:Check", icon = "fas fa-temperature-high", label = "Use Oven", job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzChop", vector3(810.45, -765.17, 26.78), 0.6, 0.6, { name="PizzChop", heading = 0.0, debugPoly=Config.Debug, minZ = 26.18, maxZ = 27.38, }, 
		{ options = { {  event = "nc-pizzathis:Menu:ChoppingBoard:Check", icon = "fas fa-utensils", label = "Use Chopping Board", job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzBurner", vector3(814.05, -752.89, 26.78), 2.4, 1.2, { name="PizzBurner", heading = 0.0, debugPoly=Config.Debug, minZ = 25.98, maxZ = 27.98, }, 
		{ options = { {  event = "nc-pizzathis:Menu:PizzaOven:Check", icon = "fas fa-temperature-high", label = "Use Stone Oven", job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzWine", vector3(809.34, -761.84, 22.3), 0.4, 1.7, { name="PizzWine", heading = 0.0, debugPoly=Config.Debug, minZ = 21.3, maxZ = 22.9, }, 
		{ options = { {  event = "nc-pizzathis:Menu:Wine", icon = "fas fa-wine-bottle	", label = "Open Wine Rack", job = "pizzathis" }, }, distance = 1.0 })	
	...
	exports['qb-target']:AddBoxZone("PizzFridge", vector3(814.09, -750.07, 26.78), 0.6, 0.6, { name="PizzFridge", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=26.83 }, 
		{ options = { {  event = "nc-pizzathis:Shop", icon = "fas fa-archive", label = "Open Drink Fridge", shop = 1, job = "pizzathis" }, }, distance = 1.5 })	
	...
	exports['qb-target']:AddBoxZone("PizzFridge3", vector3(805.68, -761.62, 26.78), 1.6, 0.6, { name="PizzFridge3", heading = 0.0, debugPoly=Config.Debug, minZ = 25.98, maxZ = 28.18, }, 
		{ options = { {  event = "nc-pizzathis:Shop", icon = "fas fa-temperature-low", label = "Open Food Fridge", shop = 2, job = "pizzathis" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzFreezer", vector3(802.75, -756.85, 26.78), 0.6, 4.0, { name="PizzFreezer", heading = 0.0, debugPoly=Config.Debug, minZ = 25.78, maxZ = 28.58, }, 
		{ options = { {  event = "nc-pizzathis:Shop", icon = "fas fa-temperature-low", label = "Open Freezer", shop = 3, job = "pizzathis" }, }, distance = 1.0 })
	...
	exports['qb-target']:AddBoxZone("PizzWash1", vector3(809.47, -765.19, 26.78), 0.6, 0.8, { name="PizzWash1", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.38, }, 
		{ options = { { event = "nc-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = "Wash Your Hands", }, }, distance = 1.5 })		
	...
	exports['qb-target']:AddBoxZone("PizzWash3", vector3(813.35, -755.46, 26.78), 0.4, 0.8, { name="PizzWash3", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.38, }, 
		{ options = { { event = "nc-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = "Wash Your Hands" }, }, distance = 1.2 })
	exports['qb-target']:AddBoxZone("PizzWash4", vector3(800.88, -767.88, 26.78), 0.8, 0.6, { name="PizzWash4", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.38, }, 
		{ options = { { event = "nc-pizzathis:washHands", icon = "fas fa-hand-holding-water", label = "Wash Your Hands", job = "pizzathis" }, }, distance = 1.5 })		
	...
	exports['qb-target']:AddBoxZone("PizzCounter", vector3(810.98, -752.9, 26.78), 0.6, 0.6, { name="PizzCounter", heading = 9.0, debugPoly=Config.Debug, minZ = 26.78, maxZ = 27.58, }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Counter", stash = "CounterRight" }, }, distance = 2.0 })
	exports['qb-target']:AddBoxZone("PizzCounter2", vector3(810.93, -749.92, 26.78), 0.7, 0.7, { name="PizzCounter2", heading = 30.0, debugPoly=Config.Debug, minZ = 26.78, maxZ = 27.58, }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Counter", stash = "CounterLeft" }, }, distance = 2.0 })
	...
	exports['qb-target']:AddBoxZone("PizzTap", vector3(814.14, -749.35, 26.78), 0.9, 0.6, { name="PizzTap", heading = 0.0, debugPoly=Config.Debug, minZ = 26.78, maxZ = 27.48, }, 
		{ options = { { event = "nc-pizzathis:Menu:Beer", icon = "fas fa-beer", label = "Pour Beer", job = "pizzathis" }, }, distance = 1.5 })
	...
	exports['qb-target']:AddBoxZone("PizzCoffee", vector3(808.78, -765.35, 26.78), 0.6, 0.6, { name="PizzCoffee", heading = 0.0, debugPoly=Config.Debug, minZ = 26.58, maxZ = 27.58, }, 
		{ options = { { event = "nc-pizzathis:JustGive", icon = "fas fa-mug-hot", label = "Pour Coffee", job = "pizzathis", id = "coffee"}, }, distance = 2.0 })				
	...
	exports['qb-target']:AddBoxZone("PizzTable", vector3(807.08, -751.57, 26.78), 1.0, 1.0, { name="PizzTable", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table1" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable2", vector3(803.13, -751.59, 26.78), 1.0, 1.0, { name="PizzTable2", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table2" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable3", vector3(799.13, -751.57, 26.78), 1.0, 1.0, { name="PizzTable3", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table3" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable4", vector3(797.96, -748.86, 26.78), 1.0, 1.0, { name="PizzTable4", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table4" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable5", vector3(795.25, -751.55, 26.78), 1.0, 1.0, { name="PizzTable5", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table5" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable6", vector3(799.46, -755.04, 26.78), 1.0, 1.0, { name="PizzTable6", heading = 0.0, debugPoly=Config.Debug, minZ=25.98, maxZ=27.18 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table6" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable7", vector3(807.71, -754.9, 26.78), 2.0, 0.8, { name="PizzTable7", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table7" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable8", vector3(805.61, -754.89, 26.78), 2.0, 0.8, { name="PizzTable8", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table8" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable9", vector3(803.51, -754.9, 26.78), 2.0, 0.8, { name="PizzTable9", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table9" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable10", vector3(801.42, -754.93, 26.78), 2.0, 0.8, { name="PizzTable10", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table10" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable11", vector3(799.32, -757.63, 26.78), 0.8, 1.4, { name="PizzTable11", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table11" }, }, distance = 2.0 })	
	exports['qb-target']:AddBoxZone("PizzTable12", vector3(799.32, -759.72, 26.78), 0.8, 1.4, { name="PizzTable12", heading = 0.0, debugPoly=Config.Debug, minZ=26.18, maxZ=26.98 }, 
		{ options = { { event = "nc-pizzathis:Stash", icon = "fas fa-hamburger", label = "Open Table", stash = "Table12" }, }, distance = 2.0 })
end)
...
--RegisterNetEvent('nc-pizzathis:toggleDuty', function() onDuty = not onDuty TriggerServerEvent('QBCore:ToggleDuty') end)

RegisterNetEvent('nc-pizzathis:washHands', function()
...
RegisterNetEvent('nc-pizzathis:MakeItem')
AddEventHandler('nc-pizzathis:MakeItem', function(data)
	if not jobCheck() then return else
		...
		if data.item == "bolognese" or data.item == "calamari" or data.item == "meatball" or data.item == "alla" or data.item == "pescatore" or data.item == "capricciosabox" or data.item == "diavolabox" or data.item == "marinarabox" or data.item == "margheritabox" or data.item == "prosciuttiobox" or data.item == "vegetarianabox" or data.item == "pizzabase" or data.item == "salami" or data.item == "ham" then
			QBCore.Functions.TriggerCallback('nc-pizzathis:get:'..data.item, function(amount) 
...
RegisterNetEvent('nc-pizzathis:Stash')
AddEventHandler('nc-pizzathis:Stash',function(data)
	id = data.stash
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "pizza_"..id)
    TriggerEvent("inventory:client:SetCurrentStash", "pizza_"..id)
end)

RegisterNetEvent('nc-pizzathis:Shop')
AddEventHandler('nc-pizzathis:Shop',function(data)
	if not jobCheck() then return else
		if data.shop == 1 then
...
function FoodProgress(ItemMake)
	...
	{ animDict = animDictNow, anim = animNow, flags = 8, },	{}, {}, function()  
		TriggerServerEvent('nc-pizzathis:GetFood', ItemMake)
...
-- // Utilities \\ 
RegisterNetEvent('nc-pizzathis:Menu:Oven:Check', function()
	if not jobCheck() then return end
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:bolognese', function(amount) if amount 		then bolognese = "✔" else bolognese = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:calamari', function(amount) if amount 		then calamari = "✔" else calamari = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:meatball', function(amount) if amount 		then meatball = "✔" else meatball = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:alla', function(amount) if amount 			then alla = "✔" else alla = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:pescatore', function(amount) if amount 		then pescatore = "✔" else pescatore = "" end end)
	Wait(500)
	TriggerEvent('nc-pizzathis:Menu:Oven')
end)
RegisterNetEvent('nc-pizzathis:Menu:Oven', function()
    exports['qb-menu']:openMenu({
		{ header = "Oven Menu", isMenuHeader = true },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["bolognese"].image.." width=35px> "..QBCore.Shared.Items["bolognese"].label.." "..bolognese, txt = "- "..QBCore.Shared.Items["meat"].label.."<br>- "..QBCore.Shared.Items["sauce"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'bolognese' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["calamari"].image.." width=35px> "..QBCore.Shared.Items["calamari"].label.." "..calamari, txt = "- "..QBCore.Shared.Items["squid"].label.."<br>- "..QBCore.Shared.Items["sauce"].label.."<br>- "..QBCore.Shared.Items["pasta"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'calamari' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["meatball"].image.." width=35px> "..QBCore.Shared.Items["meatball"].label.." "..meatball, txt = "- "..QBCore.Shared.Items["meat"].label.."<br>- "..QBCore.Shared.Items["pasta"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'meatball' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["alla"].image.." width=35px> "..QBCore.Shared.Items["alla"].label.." "..alla, txt = "- "..QBCore.Shared.Items["ham"].label.."<br>- "..QBCore.Shared.Items["pasta"].label.."<br>- "..QBCore.Shared.Items["vodka"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'alla' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pescatore"].image.." width=35px> "..QBCore.Shared.Items["pescatore"].label.." "..pescatore, txt = "- "..QBCore.Shared.Items["squid"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'pescatore' } } },
    })
end)

RegisterNetEvent('nc-pizzathis:Menu:PizzaBase:Check', function()
	if not jobCheck() then return end
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:pizzabase', function(amount) if amount 		then pizzabase = "✔" else pizzabase = "" end end)
	Wait(500)
	TriggerEvent('nc-pizzathis:Menu:PizzaBase')
end)
RegisterNetEvent('nc-pizzathis:Menu:PizzaBase', function()
    exports['qb-menu']:openMenu({
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pizzabase"].image.." width=35px> "..QBCore.Shared.Items["pizzabase"].label..' '..pizzabase, txt = "- "..QBCore.Shared.Items["pizzadough"].label.."<br>- "..QBCore.Shared.Items["sauce"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'pizzabase' } } },
    })
end)

RegisterNetEvent('nc-pizzathis:Menu:PizzaOven:Check', function()
	if not jobCheck() then return end
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:margheritabox', function(amount) if amount 		then margherita = "✔" else margherita = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:marinarabox', function(amount) if amount 		then marinara = "✔" else marinara = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:prosciuttiobox', function(amount) if amount 	then prosciuttio = "✔" else prosciuttio = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:diavolabox', function(amount) if amount 		then diavola = "✔" else diavola = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:capricciosabox', function(amount) if amount 	then capricciosa = "✔" else capricciosa = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:vegetarianabox', function(amount) if amount 	then vegetariana = "✔" else vegetariana = "" end end)
	Wait(500)
	TriggerEvent('nc-pizzathis:Menu:PizzaOven')
end)
RegisterNetEvent('nc-pizzathis:Menu:PizzaOven', function()
    exports['qb-menu']:openMenu({
		{ header = "Pizza Menu", isMenuHeader = true },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["margherita"].image.." width=35px> "..QBCore.Shared.Items["margherita"].label.." "..margherita, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["mozz"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'margheritabox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["marinara"].image.." width=35px> "..QBCore.Shared.Items["marinara"].label.." "..marinara, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["basil"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'marinarabox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["prosciuttio"].image.." width=35px> "..QBCore.Shared.Items["prosciuttio"].label.." "..prosciuttio, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["mozz"].label.."<br>- "..QBCore.Shared.Items["ham"].label.."<br> - "..QBCore.Shared.Items["pizzmushrooms"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'prosciuttiobox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["diavola"].image.." width=35px> "..QBCore.Shared.Items["diavola"].label.." "..diavola, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["mozz"].label.."<br>- "..QBCore.Shared.Items["salami"].label.."<br> - "..QBCore.Shared.Items["basil"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'diavolabox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["capricciosa"].image.." width=35px> "..QBCore.Shared.Items["capricciosa"].label.." "..capricciosa, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["ham"].label.."<br>- "..QBCore.Shared.Items["pizzmushrooms"].label.."<br> - "..QBCore.Shared.Items["olives"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'capricciosabox' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["vegetariana"].image.." width=35px> "..QBCore.Shared.Items["vegetariana"].label.." "..vegetariana, txt = "- "..QBCore.Shared.Items["pizzabase"].label.."<br>- "..QBCore.Shared.Items["mozz"].label.."<br>- "..QBCore.Shared.Items["lettuce"].label.."<br> - "..QBCore.Shared.Items["basil"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'vegetarianabox' } } },
    })
end)
RegisterNetEvent('nc-pizzathis:Menu:Beer', function()
	if not jobCheck() then return end
    exports['qb-menu']:openMenu({
		{ header = "Beer Menu", isMenuHeader = true },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["ambeer"].image.." width=35px> "..QBCore.Shared.Items["ambeer"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'ambeer' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["dusche"].image.." width=35px> "..QBCore.Shared.Items["dusche"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'dusche' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["logger"].image.." width=35px> "..QBCore.Shared.Items["logger"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'logger' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pisswasser"].image.." width=35px> "..QBCore.Shared.Items["pisswasser"].label,  params = { event = "nc-pizzathis:JustGive", args = { id = 'pisswasser' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pisswasser2"].image.." width=35px> "..QBCore.Shared.Items["pisswasser2"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'pisswasser2' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["pisswasser3"].image.." width=35px> "..QBCore.Shared.Items["pisswasser3"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'pisswasser3' } } },
    })
end)
RegisterNetEvent('nc-pizzathis:Menu:Wine', function()
	if not jobCheck() then return end
    exports['qb-menu']:openMenu({
		{ header = "Wine Cellar", isMenuHeader = true },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["amarone"].image.." width=35px> "..QBCore.Shared.Items["amarone"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'amarone' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["barbera"].image.." width=35px> "..QBCore.Shared.Items["barbera"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'barbera' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["dolceto"].image.." width=35px> "..QBCore.Shared.Items["dolceto"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'dolceto' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["housered"].image.." width=35px> "..QBCore.Shared.Items["housered"].label,  params = { event = "nc-pizzathis:JustGive", args = { id = 'housered' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["housewhite"].image.." width=35px> "..QBCore.Shared.Items["housewhite"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'housewhite' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["rosso"].image.." width=35px> "..QBCore.Shared.Items["rosso"].label, params = { event = "nc-pizzathis:JustGive", args = { id = 'rosso' } } },
    })
end)
RegisterNetEvent('nc-pizzathis:Menu:ChoppingBoard:Check', function()
	if not jobCheck() then return end
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:salami', function(amount) if amount 	then salami = "✔" else salami = "" end end)
	QBCore.Functions.TriggerCallback('nc-pizzathis:get:ham', function(amount) if amount 		then ham = "✔" else ham = "" end end)
	Wait(500)
	TriggerEvent('nc-pizzathis:Menu:ChoppingBoard')
end)
RegisterNetEvent('nc-pizzathis:Menu:ChoppingBoard', function()
    exports['qb-menu']:openMenu({
		{ header = "Chopping Board", isMenuHeader = true },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["salami"].image.." width=35px> "..QBCore.Shared.Items["salami"].label.." "..salami, txt = "- "..QBCore.Shared.Items["meat"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'salami' } } },
        { header = "<img src=nui://"..Config.link..QBCore.Shared.Items["ham"].image.." width=35px> "..QBCore.Shared.Items["ham"].label.." "..ham, txt = "- "..QBCore.Shared.Items["meat"].label, params = { event = "nc-pizzathis:MakeItem", args = { item = 'ham' } } },
    })
end)

RegisterNetEvent('nc-pizzathis:JustGive', function(data) if not jobCheck() then return else FoodProgress(data.id) end end)

RegisterNetEvent('nc-pizzathis:client:Eat', function(itemName)
...
RegisterNetEvent('nc-pizzathis:client:DrinkAlcohol', function(itemName)
...
RegisterNetEvent('nc-pizzathis:client:Drink', function(itemName)
