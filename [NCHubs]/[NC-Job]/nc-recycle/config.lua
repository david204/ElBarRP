...
Config.Locations =  {
	['Recycle'] = { name = "Recycle Center", location = vector3(744.68,-1401.77, 26.55-1.03), heading = 248.73, blipTrue = true, Sprite = 365, Scale = 0.6, Colour = 2, }, -- The location where you enter the mine 
	['Trade'] = { name = "Recyclable Trader", location = vector3(996.58,-3098.45,-39.0-1.03), heading = 230.0, blipTrue = false, Sprite = 365, Scale = 0.6, Colour = 2, }, -- The location where you enter the mine 
	['BottleBank'] = { name = "Bottle Bank", location = vector3(757.06, -1399.68, 26.57-1.0), heading = 178.1, blipTrue = true, Sprite = 642, Scale = 0.6, Colour = 2,}, -- The location where you enter the mine 
	['BottleBank2'] = { name = "Bottle Bank", location = vector3(84.01,-220.32,54.64-1.0), heading = 337.89, blipTrue = true, Sprite = 642, Scale = 0.6, Colour = 2,}, -- The location where you enter the mine 
	['BottleBank3'] = { name = "Bottle Bank", location = vector3(31.88,-1315.58,29.52-1.0), heading = 357.19, blipTrue = true, Sprite = 642, Scale = 0.6, Colour = 2,}, -- The location where you enter the mine 
	['BottleBank4'] = { name = "Bottle Bank", location = vector3(29.08,-1769.99,29.61-1.0), heading = 50.0, blipTrue = true, Sprite = 642, Scale = 0.6, Colour = 2,}, -- The location where you enter the mine 
	['BottleBank5'] = { name = "Bottle Bank", location = vector3(394.08,-877.48,29.35-1.0), heading = 310.12, blipTrue = true, Sprite = 642, Scale = 0.6, Colour = 2,}, -- The location where you enter the mine 
	['BottleBank6'] = { name = "Bottle Bank", location = vector3(-1267.97,-812.08,17.11-1.0), heading = 128.12, blipTrue = true, Sprite = 642, Scale = 0.6, Colour = 2,}, -- The location where you enter the mine 
