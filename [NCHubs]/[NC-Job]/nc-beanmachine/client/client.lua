...
CreateThread(function()
	...
	if Config.Gabz then
		exports['qb-target']:AddBoxZone("BeanWash", vector3(123.73, -1039.24, 29.28), 1.2, 0.6, { name="BeanWash", heading = 340.0, debugPoly=Config.Debug, minZ=28.88, maxZ=29.68 }, 
			{ options = { { event = "nc-beanmachine:washHands", icon = "fas fa-hand-holding-water", label = "Wash Your Hands", job = "beanmachine" }, }, distance = 1.5 })
		...
		exports['qb-target']:AddBoxZone("BeanCounter", vector3(120.54, -1040.74, 29.28), 0.6, 0.4, { name="BeanCounter", heading = 340.0, debugPoly=Config.Debug, minZ=29.08, maxZ=29.88 }, 
			{ options = { { event = "nc-beanmachine:Stash", icon = "fas fa-mug-saucer", label = "Open Counter", stash = "Counter" }, }, distance = 2.0 })
		exports['qb-target']:AddBoxZone("BeanCounter2", vector3(121.85, -1037.08, 29.28), 0.6, 0.4, { name="BeanCounter2", heading = 340.0, debugPoly=Config.Debug, minZ=29.08, maxZ=29.88 }, 
			{ options = { { event = "nc-beanmachine:Stash", icon = "fas fa-mug-saucer", label = "Open Counter", stash = "Counter2" }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("BeanReceipt", vector3(120.73, -1040.09, 29.28), 0.6, 0.6, { name="BeanReceipt", heading = 340.0, debugPoly=Config.Debug, minZ=29.08, maxZ=29.88 },
			{ options = { { event = "jim-payments:client:Charge", icon = "fas fa-credit-card", label = "Charge Customer", job = "beanmachine", 
		...
		exports['qb-target']:AddBoxZone("BeanFridge", vector3(124.51, -1037.97, 29.28), 0.85, 0.6, { name="BeanFridge", heading = 340.0, debugPoly=Config.Debug, minZ=29.28, maxZ=30.08 }, 
			{ options = { {  event = "nc-beanmachine:Shop", icon = "fas fa-archive", label = "Open Storage", job = "beanmachine" }, }, distance = 1.5 })
		...
		exports['qb-target']:AddBoxZone("BeanDrink", vector3(124.56, -1036.88, 29.28), 0.7, 0.4, { name="BeanDrink", heading = 340.0, debugPoly=Config.Debug, minZ=29.08, maxZ=29.88 }, 
			{ options = { { event = "nc-beanmachine:Menu:Drinks", icon = "fas fa-mug-hot", label = "Prepare Coffee", job = "beanmachine" }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("BeanSlush", vector3(126.07, -1036.59, 29.28), 0.6, 0.6, { name="BeanSlush", heading = 340.0, debugPoly=Config.Debug, minZ=29.08, maxZ=30.08 }, 
			{ options = { { event = "nc-beanmachine:Menu:Slush", icon = "fas fa-cocktail", label = "Prepare Slush", job = "beanmachine" }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("BeanSoda", vector3(123.56, -1042.75, 29.28), 0.6, 1.4, { name="BeanSoda", heading = 340.0, debugPoly=Config.Debug, minZ=29.08, maxZ=29.88 }, 
			{ options = { { event = "nc-beanmachine:Menu:Soda", icon = "fas fa-cocktail", label = "Grab Soda", job = "beanmachine" }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("BeanDonut", vector3(121.4, -1038.43, 29.28), 1.45, 0.6, { name="BeanDonut", heading = 340.0, debugPoly=Config.Debug, minZ=29.28, maxZ=29.88 }, 
			{ options = { { event = "nc-beanmachine:Menu:Donut", icon = "fas fa-circle-dot", label = "Grab Food", job = "beanmachine" }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("BeanClockin", vector3(126.94, -1035.84, 29.28), 1.2, 0.2, { name="BeanClockin", heading = 340.0, debugPoly=Config.Debug, minZ=29.28, maxZ=31.28 }, 
			{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = "Toggle Duty", job = "beanmachine" },
						  --{ event = "nc-bossmenu:client:OpenMenu", icon = "fas fa-clipboard-check", label = "Open Bossmenu", job = bossroles, }, 
						}, distance = 2.0 })
	end
	if Config.UncleJust then
		...
		exports['qb-target']:AddBoxZone("UBeanCounter", vector3(-634.27, 234.69, 81.88), 0.55, 0.4, { name="UBeanCounter", heading = 5.0, debugPoly=Config.Debug, minZ=81.93, maxZ=82.48 }, 
			{ options = { { event = "nc-beanmachine:Stash", icon = "fas fa-mug-saucer", label = "Open Counter", stash = "UCounter" }, }, distance = 2.0 })
		...
		exports['qb-target']:AddBoxZone("UBeanSlush", vector3(-636.74, 234.86, 81.88), 2.6, 0.4, { name="UBeanSlush", heading = 1.0, debugPoly=Config.Debug, minZ=80.88, maxZ=82.08 }, 
			{ options = { { event = "nc-beanmachine:Menu:Slush", icon = "fas fa-cocktail", label = "Prepare Slush", job = "beanmachine" },
						  { event = "nc-beanmachine:Menu:Soda", icon = "fas fa-cocktail", label = "Grab Soda", job = "beanmachine" }, }, distance = 2.0 })
...
RegisterNetEvent('nc-beanmachine:washHands', function()
...
RegisterNetEvent('nc-beanmachine:MakeItem', function(data)
	if data.craftable then
		for k, v in pairs(data.craftable[data.tablenumber]) do
			QBCore.Functions.TriggerCallback('nc-beanmachine:get', function(amount)
				if not amount then TriggerEvent('QBCore:Notify', "You don't have the correct ingredients", 'error') else TriggerEvent("nc-beanmachine:FoodProgress", data.item, data.tablenumber, data.craftable) end		
			end, data.item, data.tablenumber, data.craftable)
		end
	end
end)

RegisterNetEvent('nc-beanmachine:JustGive', function(data) if not jobCheck() then return else TriggerEvent("nc-beanmachine:FoodProgress", data.id, nil, nil)  end end)

RegisterNetEvent('nc-beanmachine:Stash', function(data) TriggerServerEvent("inventory:server:OpenInventory", "stash", "beanmachine_"..data.stash) TriggerEvent("inventory:client:SetCurrentStash", "beanmachine_"..data.stash) end)

RegisterNetEvent('nc-beanmachine:Shop', function(data)	if not onDuty then TriggerEvent('QBCore:Notify', "Not clocked in!", 'error') else TriggerServerEvent("inventory:server:OpenInventory", "shop", "beanmachine", Config.FoodItems)	end end)

RegisterNetEvent('nc-beanmachine:FoodProgress', function(ItemMake, tablenumber, craftable)
	if craftable then
	...
	{ animDict = animDictNow, anim = animNow, flags = 16, }, {}, {}, function()  
		TriggerServerEvent('nc-beanmachine:GetFood', ItemMake, tablenumber, craftable)
...
RegisterNetEvent('nc-beanmachine:Menu:Drinks', function()
		...
		for i = 1, #Crafting.Drinks do
			for k, v in pairs(Crafting.Drinks[i]) do
				if k ~= "img" then
					...
					DrinksMenu[#DrinksMenu + 1] = { header = setheader, txt = settext, params = { event = "nc-beanmachine:MakeItem", args = { item = k, tablenumber = i, craftable = Crafting.Drinks } } }
...
RegisterNetEvent('nc-beanmachine:Menu:Slush', function()
	if not jobCheck() then return end
	local SlushMenu = {}
		...
		for i = 1, #Crafting.Slush do
			for k, v in pairs(Crafting.Slush[i]) do
				if k ~= "img" then
					...
					SlushMenu[#SlushMenu + 1] = { header = setheader, txt = settext, params = { event = "nc-beanmachine:MakeItem", args = { item = k, tablenumber = i, craftable = Crafting.Slush } } }
					settext, setheader = nil
				end
			end
		end
...
RegisterNetEvent('nc-beanmachine:Menu:Donut', function()
	if not jobCheck() then return end
	local DonutMenu = {}
	DonutMenu[#DonutMenu + 1] = { header = "Food Menu", txt = "", isMenuHeader = true }
	DonutMenu[#DonutMenu + 1] = { header = "<img src=https://i.imgur.com/myyavDX.png width=25px>"..QBCore.Shared.Items['beandonut'].label, params = { event = "nc-beanmachine:JustGive", args = { id = 'beandonut' } } }
	DonutMenu[#DonutMenu + 1] = { header = "<img src=https://i.imgur.com/hhBCnJ2.png width=25px>"..QBCore.Shared.Items['chocolate'].label, params = { event = "nc-beanmachine:JustGive", args = { id = 'chocolate' } } }
	DonutMenu[#DonutMenu + 1] = { header = "<img src=https://i.imgur.com/cdZvyBJ.png width=25px>"..QBCore.Shared.Items['crisps'].label, params = { event = "nc-beanmachine:JustGive", args = { id = 'crisps' } } }
	DonutMenu[#DonutMenu + 1] = { header = "<img src=https://i.imgur.com/5ScW9Gn.png width=25px>"..QBCore.Shared.Items['watermelon'].label, params = { event = "nc-beanmachine:JustGive", args = { id = 'watermelon' } } }
	DonutMenu[#DonutMenu + 1] = { header = "<img src=https://i.imgur.com/3DCQEs1.png width=25px>"..QBCore.Shared.Items['cheesecake'].label, params = { event = "nc-beanmachine:JustGive", args = { id = 'cheesecake' } } }
	DonutMenu[#DonutMenu + 1] = { header = "<img src=https://i.imgur.com/l7nFQgV.png width=25px>"..QBCore.Shared.Items['tosti'].label, params = { event = "nc-beanmachine:JustGive", args = { id = 'tosti' } } }
	exports['qb-menu']:openMenu(DonutMenu)
end)

RegisterNetEvent('nc-beanmachine:Menu:Soda', function()
	if not jobCheck() then return end
    exports['qb-menu']:openMenu({
		{ header = "Soda Menu", isMenuHeader = true },
        { header = "<img src=https://i.imgur.com/8HwNjk3.png width=25px>"..QBCore.Shared.Items["ecola"].label, params = { event = "nc-beanmachine:JustGive", args = { id = 'ecola' } } },
        { header = "<img src=https://i.imgur.com/rS8DMS7.png width=25px>"..QBCore.Shared.Items["ecolalight"].label, params = { event = "nc-beanmachine:JustGive", args = { id = 'ecolalight' } } },
        { header = "<img src=https://i.imgur.com/6hEnNqK.png width=25px>"..QBCore.Shared.Items["sprunk"].label, params = { event = "nc-beanmachine:JustGive", args = { id = 'sprunk' } } },
        { header = "<img src=https://i.imgur.com/JpinZC7.png width=25px>"..QBCore.Shared.Items["sprunklight"].label,  params = { event = "nc-beanmachine:JustGive", args = { id = 'sprunklight' } } },
    })
end)

RegisterNetEvent('nc-beanmachine:client:Drink', function(itemName)
...
RegisterNetEvent('nc-beanmachine:client:Eat', function(itemName)
