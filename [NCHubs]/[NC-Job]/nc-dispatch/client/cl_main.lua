...
RegisterNetEvent("nc-dispatch:client:Explosion", function(data)
	exports["nc-dispatch"]:Explosion()
end)

RegisterNetEvent("nc-dispatch:client:removeCallBlip", function(blipId)
	RemoveBlip(blips[blipId])
end)

RegisterNetEvent("nc-dispatch:client:clearAllBlips", function()
