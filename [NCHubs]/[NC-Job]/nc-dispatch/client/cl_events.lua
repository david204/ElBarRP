...
RegisterNetEvent('nc-dispatch:client:drugsale', function()
    DrugSale()
end)
...
RegisterNetEvent("nc-dispatch:client:officerdown", function ()
    OfficerDown()
end)
...
RegisterNetEvent("nc-dispatch:client:emsdown", function ()
    EmsDown()
end)
