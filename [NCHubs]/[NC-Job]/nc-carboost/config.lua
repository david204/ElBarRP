...
Config.Alert = 'nc-dispatch' -- qb-dispatch / linden_outlawalert / notification, only use qb-dispatch when its on stable release
...
Config.VINChance = 50 -- chance police to find out the VIN is scratched or no
