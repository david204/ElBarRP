...
function AlertBoosting(netid, type)
    ...
    elseif type == "nc-dispatch" then
        exports['nc-dispatch']:CarBoosting(car)
    else
        TriggerServerEvent('nc-carboost:notifypolice', netid)
    end
    ...
    CreateThread(function ()
        while DoesEntityExist(car) do
            ...
            if not Hacked then
                ...
                TriggerServerEvent('nc-carboost:notifyboosting', carPos, car)
            end
        end
    end)
end
...
-- From qb-dispatch
RegisterNetEvent('nc-carboost:notifyboosting', function (pos, veh)
