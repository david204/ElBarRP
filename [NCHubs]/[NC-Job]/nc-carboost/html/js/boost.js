...
function loadBoostData() {
  fetch("https://nc-carboost/setupboostapp", {
    method: "POST",
    headers: {
...
function buyContract(event) {
  Confirm.open({
    ...
    cancelText: "No",
    onOk: () => {
      fetch("https://nc-carboost/buycontract", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
function transferContract(event) {
  ...
  Confirm.Input({
    ...
    onOk: function (value) {
      ...
      fetch("https://nc-carboost/transfercontract", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
function sellContract(event) {
  ...
  Confirm.Input({
    ...
    onOk: (value) => {
      if (value) {
        fetch(`https://nc-carboost/sellcontract`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
...
function toggleBoosting(event) {
  ...
  if (isStart) {
    ...
    function checkCanStart(type) {
      fetch("https://nc-carboost/canStartContract", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
function startContract(data) {
  $.post("https://nc-carboost/startcontract", JSON.stringify({ data: data }));
}

function stopContract(data) {
  $.post("https://nc-carboost/stopcontract", JSON.stringify({ id: data }));
}
