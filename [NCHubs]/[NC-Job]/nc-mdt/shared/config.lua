...
Config.Fuel = "nc-fuel" -- "LegacyFuel", "nc-fuel"
...
-- this is a hack, because the qb-menu in nc-policejob populates an impound location and passed it through to the event.
-- if this impound locations are changed in nc-policejob, they must also be changed here.
