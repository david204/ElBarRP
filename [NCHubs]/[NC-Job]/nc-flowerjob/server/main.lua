...
-------------------------flower-------------------------
QBCore.Functions.CreateCallback('nc-flowerjob:server:get:bucket', function (source,cb)
    local src = source
...
RegisterServerEvent("nc-flowerjob:server:flowerpick")
AddEventHandler("nc-flowerjob:server:flowerpick", function()
    local src = source
...
QBCore.Functions.CreateCallback('nc-flowerjob:server:get:processflo', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-flowerjob:server:processflo', function()
    local source = source
...
QBCore.Functions.CreateCallback('nc-flowerjob:server:get:packingflo', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-flowerjob:server:packingflo', function()
    local source = source
    local Player = QBCore.Functions.GetPlayer(tonumber(source))
    local amount = 1
...
-------------------------seller-------------------------------
QBCore.Functions.CreateCallback('nc-flowerjob:server:get:sellflower', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nc-flowerjob:server:sellflower')
AddEventHandler('nc-flowerjob:server:sellflower', function()
