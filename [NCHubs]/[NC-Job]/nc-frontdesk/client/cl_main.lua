...
CreateThread(function() 
	for k, v in pairs(Config.Locations["police"]) do
        ...
        options = {
            {
                type = "client",
                event = "nc-frontdesk:client:OpenFrontDesk",
                icon = "fas fa-desktop",
                label = "Front Desk",
            },
        },
...
RegisterNetEvent('nc-frontdesk:client:OpenFrontDesk',function()
    if IsValidJob() then
    local FrontDeskMenu = {
        {
        ...
        },
        {
            ...
            params = {
                event = 'nc-frontdesk:client:ToggleDuty'
            }
        },  
        {
            ...
            params = {
                event = 'nc-frontdesk:client:OpenAssistanceMenu'
            }
        },
        {
            header = 'Exit Menu',
    ...
    local FrontDeskMenu = {
        ...
        },
        {
            ...
            disabled = true,
            params = {
                event = 'nc-frontdesk:client:OpenDutyMenu'
            }
        },  
        {
            header = 'Assistance Menu',
...
RegisterNetEvent('nc-frontdesk:client:ToggleDuty',function()
    TriggerServerEvent('QBCore:ToggleDuty')
end)


RegisterNetEvent('nc-frontdesk:client:OpenAssistanceMenu',function()
    local AssistanceMenu = {
        ...
        },
        {
            ...
            icon = 'fas fa-hand',
            params = {
                event = 'nc-frontdesk:client:RequestAssistance',
                args = 'assistance',
            }
        },  
        {
...
RegisterNetEvent('nc-frontdesk:client:RequestAssistance',function(type)
    ...
    elseif Config.Dispatch == "nc-dispatch" then
        local PlayerData = QBCore.Functions.GetPlayerData()
