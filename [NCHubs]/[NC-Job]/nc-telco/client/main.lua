...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
    ...
    TriggerEvent('nc-telco:client:UpdateBlip', Config.CurrentProject)
    BlipBilding()
end)
...
function getNewLocation()
    ...
    if location ~= 0 then
        ...
        TriggerEvent('nc-telco:client:UpdateBlip', location)
    else
        LocationsDone = {}
        ...
        --TriggerEvent('nc-telco:client:UpdateBlip', 0)
...
RegisterNetEvent('nc-telco:client:SetTaskState')
AddEventHandler('nc-telco:client:SetTaskState', function(Task, IsBusy, IsCompleted)
...
function DoTask()
    ...
    TriggerEvent('nc-telco:client:SetTaskState', BuilderData.CurrentTask, true, false)
...
function TouchProcess()
    if not BuilderData.ShowDetails then
        ...
        TasserAnim()
        TriggerEvent('nc-telco:client:SetTaskState', BuilderData.CurrentTask, false, false)
        ...
        QBCore.Functions.Progressbar("touch_process", "Repairing ..", math.random(6000,8000), false, true, {
            ...
            TriggerEvent('nc-telco:client:SetTaskState', BuilderData.CurrentTask, true, true)
...
-- // Blips //
RegisterNetEvent('nc-telco:client:UpdateBlip')
AddEventHandler('nc-telco:client:UpdateBlip', function(id)
...
-- // START - Spanw vehicle //
RegisterNetEvent('nc-telco:client:SpawnVehicle')
AddEventHandler('nc-telco:client:SpawnVehicle', function()
    isColddown = true
    ColdDown()
    ...
    QBCore.Functions.SpawnVehicle(vehicleInfo, function(veh)
        ...
        exports['nc-fuel']:SetFuel(veh, 100.0)
                        ...
                        if IsPedInAnyVehicle(PlayerPedId(), false) then
                            if GetPedInVehicleSeat(GetVehiclePedIsIn(PlayerPedId()), -1) == PlayerPedId() then
                                if isTruckerVehicle(GetVehiclePedIsIn(PlayerPedId(), false)) then
                                    ...
                                    TriggerServerEvent('nc-telco:server:SuretyBond', false)
                                else
                            ...
                            TriggerServerEvent('nc-telco:server:SuretyBond', true, Config.Vehicle)
                        end
                    else 
                            ...
                            if TaskData.completed == TaskData.total then 
                                ...
                                if IsControlJustPressed(0, 47) then
                                    ...
                                    while ResetTask < TaskData.total+1 do
                                        ...
                                        TriggerEvent('nc-telco:client:SetTaskState', ResetTask, false, false)  
                                    ...
                                    getNewLocation()
                                    -- Paysistem
                                    TriggerServerEvent('nc-telco:server:cWJ0ZWxjbw', TaskData.completed) 
