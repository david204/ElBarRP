...
RegisterNetEvent("nc-vehicleshopui:removeStock",function(model)
    for i=1,#data do
...
RegisterNetEvent("nc-vehicleshopui:setVehicleOwned",function(vehicleData)
    local src = source
    local player = QBCore.Functions.GetPlayer(src)
    local stateVehicle = 0
    exports.oxmysql:insert("INSERT INTO `player_vehicles` (`license`, `citizenid`, `vehicle`, `hash`, `mods`, `plate`, `state`) VALUES ('"..player.PlayerData.license.."', '"..player.PlayerData.citizenid.."', '"..vehicleData.displayName.."', '"..vehicleData.model.."', '".."{}".."', '"..vehicleData.plate.."', '"..stateVehicle.."')")
end)