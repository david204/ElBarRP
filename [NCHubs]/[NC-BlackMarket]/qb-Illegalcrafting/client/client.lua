...
RegisterNUICallback('craft', function(data)
    ...
    SetDisplay(false)
    QBCore.Functions.TriggerCallback('qb-Illegalcrafting:server:enoughMaterials', function(hasMaterials)
        if hasMaterials then
            ...
            QBCore.Functions.Progressbar('crafting-prog', 'Crafting...', 5000, false, false, {
                ...
                TriggerServerEvent('qb-Illegalcrafting:server:craftItem', data.item, data.location)
            ...
            options = {
                {
                    ...
                    label = "Craft",
                    action = function()
                        TriggerEvent('qb-Illegalcrafting:client:openCrafting', k)
                    end,
                }
            },
            distance = 2.5
...
RegisterNetEvent('qb-Illegalcrafting:client:openCrafting', function(tableName)
