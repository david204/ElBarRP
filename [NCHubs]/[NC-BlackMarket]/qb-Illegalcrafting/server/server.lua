...
RegisterNetEvent('qb-Illegalcrafting:server:craftItem', function(item, location) 
...
QBCore.Functions.CreateCallback('qb-Illegalcrafting:server:enoughMaterials', function(source, cb, materials)
    local src = source
