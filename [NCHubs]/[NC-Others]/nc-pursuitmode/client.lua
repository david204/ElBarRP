...
local function changeVehicleMode(vehicle)
    ...
    TriggerEvent('nc-pursuitmode:vehicleModeChanged', currentVehicleMode)
end
...
RegisterNetEvent('nc-pursuitmode:client:changeVehicleMode')
AddEventHandler('nc-pursuitmode:client:changeVehicleMode', function()
...
RegisterCommand("pursuitmode", function(source, args, rawCommand)
    TriggerEvent('nc-pursuitmode:client:changeVehicleMode')
end, false)
