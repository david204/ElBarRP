...
CreateThread(function()
    ...
    exports['qb-target']:AddBoxZone("KartingPed", Config.Locations['PedTarget'], 1, 1, {
        ...
        options = {
            {
                event = "nc-karting:client:MenuAluger",
                icon = "fas fa-car",
...
RegisterNetEvent('nc-karting:client:MenuAluger', function()
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            icon = "fas fa-ticket",
            event = "nc-karting:client:Ticket1",
            params = {
                event = "nc-karting:client:Ticket",
                args = 1
            },
        },
        {
...
RegisterNetEvent('nc-karting:client:Ticket', function(args)
