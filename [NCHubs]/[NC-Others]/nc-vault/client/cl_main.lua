...
AddEventHandler('re2-vault:openStorageMenu', function(data)
    ...
    local dialog = exports['nc-input']:ShowIycInput({
        header = "Password",
        submitText = "Submit",
        inputs = {
            {
...
AddEventHandler('re2-vault:createStorage', function(location)
    local player=QBCore.Functions.GetPlayerData()
    local citizenid=player.citizenid
    local cpdialog = exports['nc-input']:ShowIycInput({
        header = "Create Storage [Costs - $250]",
        submitText = "Submit",
        inputs = {
            {
...
AddEventHandler('re2-vault:addMemberToStorage', function(data)
    ...
    local citizenid=player.citizenid
    -- local storagename=location.."_"..citizenid
    local mdialog = exports['nc-input']:ShowIycInput({
        header = "Add Member",
        submitText = "Submit",
        inputs = {
            {
