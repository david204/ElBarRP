...
Config.FuelTargetExport = false -- This is only used to fix this issue: https://github.com/CodineDev/nc-fuel/issues/3. <br> <br> If you don't have this issue and haven't installed this exports in qb-target, then this should be false. Otherwise there will be an error.
Config.InventoryBusy = true -- When true, the inventory state will be set to busy while refuelling. If needed, set this to false if incountering the following issue: https://github.com/CodineDev/nc-fuel/issues/6 
-- Syphoning --
...
Config.SyphonDispatchSystem = "nc-dispatch" -- Options: "ps-dispatch", "qb-dispatch", "qb-default" (just blips) or "custom" (Custom: you must configure yourself!)
-- Anims --
