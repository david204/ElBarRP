...
- [qb-inventory](https://github.com/qbcore-framework/qb-inventory) (nchub)
...
### qb-target with pokemon shops ###
 You will need to remove the drawtext in nc-shops if you dont want the drawtext to show up.

 If you dont want to use the qb-target go to client.lua in nc-pokemontcg and remove the exports at the bottom.
## nc-shop locations (Buy Location) ### 
```
    ["pokemon"] = {
        [1] = {
            name = 'boosterpack',
...
## Original nc-pokemontcg

- [nc-pokemontcg](https://github.com/KamuiKody/nc-pokemontcg)
- 
