...
RegisterNetEvent("nc-pokemontcg:client:badgesound")
AddEventHandler("nc-pokemontcg:client:badgesound", function()
...
exports['qb-target']:AddBoxZone("Pokemon1", vector3(-140.32, 222.99, 94.99), 1, 1, {
    name="Pokemon1",
    heading=0,
    debugPoly=false,
    minZ=93.15,
...
exports['qb-target']:AddBoxZone("Pokemon2", vector3(-140.32, 224.7, 94.99), 1, 1,  {
    name="Pokemon2",
    heading=0,
    debugPoly=false,
    minZ=93.95,
