...
RegisterNetEvent('nc-parkingmeter:server:payParking', function(pos)
    local src = source
...
QBCore.Functions.CreateCallback('nc-parkingmeter:server:checkParking', function(source, cb, pos)
