...
QBCore.Functions.CreateCallback('pacificheist:server:hasItem', function(source, cb, item)
    ...
    if player and playerItem ~= nil then
        ...
        TriggerClientEvent('QBCore:Notify', src, "you missed something..", "error")
    end
end)
...
RegisterServerEvent("pacificheist:yonatan:GoldUSB")
AddEventHandler("pacificheist:yonatan:GoldUSB", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent("pacificheist:yonatan:GreenfUSB")
AddEventHandler("pacificheist:yonatan:GreenfUSB", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent("pacificheist:yonatan:BlueUSB")
AddEventHandler("pacificheist:yonatan:BlueUSB", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent("pacificheist:yonatan:VARHelmet")
AddEventHandler("pacificheist:yonatan:VARHelmet", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.AddItem('var_helmet', 6)
    TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items['var_helmet'], "add")
end)
