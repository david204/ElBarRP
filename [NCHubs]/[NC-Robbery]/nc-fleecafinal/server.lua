...
RegisterServerEvent("nc-fleeca:yonatan:GiveCard")
AddEventHandler("nc-fleeca:yonatan:GiveCard", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent("nc-fleeca:yonatan:GreenUSB")
AddEventHandler("nc-fleeca:yonatan:GreenUSB", function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
