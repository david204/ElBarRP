...
local menu = MenuV:CreateMenu(false, 'Admin Menu', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test')
local menu2 = MenuV:CreateMenu(false, 'Admin Options', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test1')
local menu4 = MenuV:CreateMenu(false, 'Online Players', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test3')
local menu5 = MenuV:CreateMenu(false, 'Manage Server', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test4')
local menu6 = MenuV:CreateMenu(false, 'Available Weather Options', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test5')
local menu7 = MenuV:CreateMenu(false, 'Dealer List', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test6')
local menu8 = MenuV:CreateMenu(false, 'Ban', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test7')
local menu9 = MenuV:CreateMenu(false, 'Kick', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test8')
local menu10 = MenuV:CreateMenu(false, 'Permissions', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test9')
local menu11 = MenuV:CreateMenu(false, 'Developer Options', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test10')
local menu12 = MenuV:CreateMenu(false, 'Vehicle Options', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test11')
local menu13 = MenuV:CreateMenu(false, 'Vehicle Categories', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test12')
local menu14 = MenuV:CreateMenu(false, 'Vehicle Models', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv', 'test13')
...
menu_button11:On("select",function()
    ...
    for k,v in ipairs(elements) do
        local menu_button14 = menu6:AddButton({icon = v.icon,label = v.label,value = v,description = v.description,select = function(btn)
            ...
            TriggerServerEvent('nc-weathersync:server:setWeather', selection.value)
...
RegisterNetEvent('nc-clothing:client:openMenu')
AddEventHandler('nc-clothing:client:openMenu', function()
    TriggerEvent('nc-clothing:client:openMenu', 'clothesmenu')
end)

local function OpenDealerMenu(dealer)
    local EditDealer = MenuV:CreateMenu(false, 'Edit Dealer ' .. dealer["name"], menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv')
...
RegisterNetEvent('nc-admin:client:SendStaffChat')
AddEventHandler('nc-admin:client:SendStaffChat', function(name, msg)
    TriggerServerEvent('nc-admin:server:StaffChatMessage', name, msg)
end)
...
local function OpenPlayerMenus(player)
    local Players = MenuV:CreateMenu(false, player.cid .. ' Options', menuLocation, 192, 192, 192, 'size-125', 'none', 'menuv') -- Players Sub Menu
    Players:ClearItems()
...
menu_button13:On("select", function(item, value)
    TriggerServerEvent("nc-weathersync:server:setTime", value, value)
