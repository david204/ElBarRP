...
CreateThread(function()
	for store, _ in pairs(Config.Locations) do
		if Config.Locations[store]["showblip"] then
            ...
            elseif Config.Locations[store]["products"] == Config.Products["camerashop"] then
				SetBlipSprite(StoreBlip, 184)
				SetBlipScale(StoreBlip, 0.6)
                SetBlipColour(StoreBlip, 43)
            elseif Config.Locations[store]["products"] == Config.Products["petshop"] then
				SetBlipSprite(StoreBlip, 442)
				SetBlipScale(StoreBlip, 0.6)
                SetBlipColour(StoreBlip, 8)
            elseif Config.Locations[store]["products"] == Config.Products["masker"] then
