...
local function NextWeatherStage()
    ...
    TriggerEvent("nc-weathersync:server:RequestStateSync")
end

RegisterNetEvent('nc-weathersync:server:RequestStateSync', function()
    TriggerClientEvent('nc-weathersync:client:SyncWeather', -1, CurrentWeather, blackout)
    TriggerClientEvent('nc-weathersync:client:SyncTime', -1, baseTime, timeOffset, freezeTime)
end)

RegisterNetEvent('nc-weathersync:server:RequestCommands', function()
    local src = source
    if isAllowedToChange(src) then
        TriggerClientEvent('nc-weathersync:client:RequestCommands', src, true)
    end
end)

RegisterNetEvent('nc-weathersync:server:setWeather', function(weather)
...
RegisterNetEvent('nc-weathersync:server:setTime', function(hour, minute)
...
RegisterNetEvent('nc-weathersync:server:toggleBlackout', function()
