...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('nc-weathersync:server:RequestStateSync')
    TriggerServerEvent('nc-weathersync:server:RequestCommands')
end)

RegisterNetEvent('nc-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('nc-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('nc-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('nc-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('nc-weathersync:client:RequestCommands', function(isAllowed)
    if isAllowed then
...
RegisterNetEvent('nc-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
