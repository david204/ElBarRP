...
RegisterNetEvent('strez:client:SendMailAlertsBasic', function(text)
    ...
    TriggerServerEvent('qb-phone:server:sendNewMail', {
        sender = 'District of Los Santos City',
...
RegisterNetEvent('strez:client:SendMailTsunamiManual', function(text)
    ...
    TriggerServerEvent('nc-weathersync:server:setWeather', 'THUNDER')
...
RegisterNetEvent('strez:client:SendMailTsunamiManualOverride', function(text)
    ...
    TriggerServerEvent('qb-phone:server:sendNewMail', {
        sender = 'District of Los Santos City',
        subject = 'Emergency Alert',
        message = 'The National Weather Service has issued a TSUNAMI WARNING for Los Santos City, In 15 minutes! Please start heading home or somewhere local for SAFETY!',
        button = {}
    })
    Wait(math.random(30000, 60000))
    TriggerServerEvent('nc-weathersync:server:setWeather', 'THUNDER')
...
RegisterNetEvent('strez:client:SendMailTsunamiAuto5', function(text)
    ...
    TriggerServerEvent('qb-phone:server:sendNewMail', {
        sender = 'District of Los Santos City',
        subject = 'Emergency Alert',
        message = 'The National Weather Service has issued a TSUNAMI WARNING for Los Santos City, In 5 minutes! Los Santos City is losing City Power, Please start heading home or somewhere local for SAFETY!',
        button = {}
    })
    Wait(math.random(10000, 20000))
    TriggerServerEvent('nc-weathersync:server:toggleBlackout')
    Wait(math.random(13000, 23000))
    TsunamiEffect()
end)
...
RegisterNetEvent('strez:client:SendMailTsunamiAuto1', function(text)
    ...
    TriggerServerEvent('qb-phone:server:sendNewMail', {
        sender = 'District of Los Santos City',
        subject = 'Emergency Alert',
        message = 'The National Weather Service has issued a TSUNAMI WARNING for Los Santos City, In 1 minutes! Please start heading home or somewhere local for SAFETY!',
        button = {}
    })
    Wait(math.random(13000, 23000))
    TsunamiEffect()
