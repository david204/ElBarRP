...
local function DamageRandomComponent()
	if GetResourceState('nc-mechanicjob') ~= "started" then return end
    ...
    exports['nc-mechanicjob']:SetVehicleStatus(QBCore.Functions.GetPlate(vehicle), randomComponent, exports['nc-mechanicjob']:GetVehicleStatus(QBCore.Functions.GetPlate(vehicle), randomComponent) - randomDamage)
end
