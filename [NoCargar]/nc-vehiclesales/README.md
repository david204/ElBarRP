# nc-vehiclesales
Used Car Sale for nchub Framework :blue_car:
...
- [nc-garagess](https://github.com/qbcore-framework/nc-garagess) - Vehicle ownership
- [qb-phone](https://github.com/qbcore-framework/qb-phone) - For the e-mail
- [nc-logs](https://github.com/qbcore-framework/nc-logs) - Keep event logs
...
- Import `nc-vehiclesales.sql` in your database
...
ensure nc-vehiclesales
```

## Configuration
- To adjust tax, go to nc-vehiclesales\server\main.lua row 85 and change "77" to your liking
```
Config = Config or {}
