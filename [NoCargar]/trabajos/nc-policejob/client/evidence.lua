...
local PoliceEvidence = {
    [1] = { ['x'] = 483.5, ['y'] = -987.87, ['z'] = 30.69, ['h'] = 179.32073 },
    [2] = { ['x'] = 474.31, ['y'] = -990.75, ['z'] = 26.27, ['h'] = 179.32073 }
}
...
AddEventHandler('police:evidence', function(box)
    ...
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "police-evidence_" .. box, {
        maxweight = 4000000,
        slots = 500,
    })
