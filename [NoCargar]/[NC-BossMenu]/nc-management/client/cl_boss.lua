...
RegisterNetEvent('nc-bossmenu:client:OpenMenu', function()
    ...
    local bossMenu = {
        ...
        },
        {
            ...
            params = {
                event = "nc-bossmenu:client:employeelist",
            }
        },
        {
            ...
            params = {
                event = "nc-bossmenu:client:HireMenu",
            }
        },
        {
            ...
            params = {
                event = "nc-bossmenu:client:Stash",
            }
        },
        {
            header = "Outfits",
        ...
        },
        {
            ...
            params = {
                event = "nc-bossmenu:client:SocietyMenu",
            }
        },
    }
...
RegisterNetEvent('nc-bossmenu:client:employeelist', function()
    local EmployeesMenu = {
        {
    ...
    QBCore.Functions.TriggerCallback('nc-bossmenu:server:GetEmployees', function(cb)
        for _, v in pairs(cb) do
            EmployeesMenu[#EmployeesMenu + 1] = {
                ...
                params = {
                    event = "nc-bossmenu:client:ManageEmployee",
                    args = {
                        player = v,
                        work = PlayerJob
                    }
        ...
        EmployeesMenu[#EmployeesMenu + 1] = {
            ...
            icon = "fa-solid fa-angle-left",
            params = {
                event = "nc-bossmenu:client:OpenMenu",
            }
        }
...
RegisterNetEvent('nc-bossmenu:client:ManageEmployee', function(data)
    local EmployeeMenu = {
        {
    ...
    for k, v in pairs(QBCore.Shared.Jobs[data.work.name].grades) do
        EmployeeMenu[#EmployeeMenu + 1] = {
            ...
            params = {
                isServer = true,
                event = "nc-bossmenu:server:GradeUpdate",
    ...
    EmployeeMenu[#EmployeeMenu + 1] = {
        ...
        params = {
            isServer = true,
            event = "nc-bossmenu:server:FireEmployee",
...
RegisterNetEvent('nc-bossmenu:client:Stash', function()
...
RegisterNetEvent('nc-bossmenu:client:Wardrobe', function()
    TriggerEvent('nc-clothing:client:openOutfitMenu')
end)

RegisterNetEvent('nc-bossmenu:client:HireMenu', function()
    local HireMenu = {
        {
    ...
    QBCore.Functions.TriggerCallback('nc-bossmenu:getplayers', function(players)
        for _, v in pairs(players) do
            if v and v ~= PlayerId() then
                HireMenu[#HireMenu + 1] = {
                    ...
                    params = {
                        isServer = true,
                        event = "nc-bossmenu:server:HireEmployee",
                        args = v.sourceplayer
                    }
                }
            end
...
RegisterNetEvent('nc-bossmenu:client:SocietyMenu', function()
    QBCore.Functions.TriggerCallback('nc-bossmenu:server:GetAccount', function(cb)
        local SocietyMenu = {
            {
            ...
            },
            {
                ...
                params = {
                    event = "nc-bossmenu:client:SocetyDeposit",
                    args = comma_value(cb)
                }
            },
            {
                ...
                params = {
                    event = "nc-bossmenu:client:SocetyWithDraw",
                    args = comma_value(cb)
                }
            },
            {
...
RegisterNetEvent('nc-bossmenu:client:SocetyDeposit', function(money)
    ...
    if deposit then
        ...
        TriggerServerEvent("nc-bossmenu:server:depositMoney", tonumber(deposit.amount))
    end
end)

RegisterNetEvent('nc-bossmenu:client:SocetyWithDraw', function(money)
    ...
    if withdraw then
        ...
        TriggerServerEvent("nc-bossmenu:server:withdrawMoney", tonumber(withdraw.amount))
    end
end)
                            ...
                            if #(pos - coords) < 5.0 then
                                ...
                                if #(pos - coords) <= 1.5 then
                                    ...
                                    if IsControlJustReleased(0, 38) then
                                        exports['qb-core']:HideText()
                                        TriggerEvent("nc-bossmenu:client:OpenMenu")
                                    end
                                end
